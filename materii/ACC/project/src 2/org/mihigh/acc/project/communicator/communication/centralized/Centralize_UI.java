...
public class Centralize_UI {

  public final JTextArea textArea;
  public final int id;
  public final CentralizeNode centralizeNode;

  public Centralize_UI(int id, final CentralizeNode centralizeNode) {
    this.id = id;
    ...
    send.addActionListener(new AbstractAction() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        centralizeNode.getProtocol().typedMessage(new Action(Action.EventType.INSERT, text, start));
      }
    });
    ...
    del.addActionListener(new AbstractAction() {
      ...
      public void actionPerformed(ActionEvent e) {
        int start = Integer.valueOf(position.getText());
        centralizeNode.getProtocol().typedMessage(new Action(Action.EventType.DELETE, "", start));
      }
    });
  ...
  public void insertAsTyped(String text, int poz) {
    centralizeNode.getProtocol().typedMessage(new Action(Action.EventType.INSERT, text, poz));
  }
  ...
  public void removeAsTyped(int poz) {
    centralizeNode.getProtocol().typedMessage(new Action(Action.EventType.DELETE, "", poz));
  }
