...
public abstract class AbstractEnvironment implements Environment
{
	public static class AgentData
	{
        ...
        public AgentData(Agent linkedAgent, Position currentPosition, Orientation currentOrientation, double score)
		{
			agent = linkedAgent;
	...
	public void addAgent(Agent agent, Position initialPosition, Orientation initialOrientation)
	{
		...
		agents.add(new AgentData(agent, initialPosition, initialOrientation, 0));
	}
}
